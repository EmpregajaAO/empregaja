        ...
        <section className="py-12 md:py-16 lg:py-20 bg-gradient-subtle px-4">
          <div className="container max-w-7xl mx-auto">
            <div className="max-w-4xl mx-auto text-center space-y-6 md:space-y-8">
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Para Candidatos</h1>
              ...
              <div className="grid lg:grid-cols-2 gap-6 md:gap-8 mt-8 md:mt-12">
                ...
                <div className="space-y-4 md:space-y-6 bg-card p-6 md:p-8 rounded-lg border">
                  <h3 className="text-xl md:text-2xl font-bold">Plano de Cadastro</h3>
                  <div className="space-y-2">
                    <p className="text-2xl md:text-3xl font-bold text-primary">1.000 Kz</p>
                    <p className="text-sm md:text-base text-muted-foreground">Pagamento inicial único</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-xl md:text-2xl font-bold text-accent">500 Kz/mês</p>
                    <p className="text-sm md:text-base text-muted-foreground">Para criarmos o perfil por VC</p>
                  </div>
                  <a
